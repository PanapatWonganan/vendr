...
class PurchaseRequisitionController extends Controller
{
    ...
    public function approve(Request $request, PurchaseRequisition $purchaseRequisition)
    {
        ...
        try {
            ...
            // If this is a direct purchase PR, complete it immediately (no PO needed)
            if ($purchaseRequisition->isDirectPurchase()) {
                $purchaseRequisition->completeDirectPurchase('จัดซื้อตรงเสร็จสิ้นโดยอัตโนมัติหลังการอนุมัติ');
            }
    ...
    public function createDirectSmall()
    {
        ...
        $users = User::all(); // For prepared_by dropdown
    ...
    public function storeDirectSmall(Request $request)
    {
        ...
        try {
            ...
            $pr = PurchaseRequisition::create([
                'company_id' => auth()->user()->company_id ?? session('selected_company_id', 1),
