...
<head>
    ...
    <title>Scope of Work (ประเภทเช่า) - {{ $purchaseOrder->po_number }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        ...
        <div class="title-section">
            <div class="work-type">ชื่องาน : <strong>{{ $workTypeLabel ?? 'เช่า' }}</strong></div>
        ...
        <div class="section">
            ...
            <div class="content-block">
                {{ $participantLabel ?? 'ผู้ให้เช่า' }}จะต้องดำเนินการให้เช่าอสังหาริมทรัพย์หรือที่ดิน พร้อมสิ่งปลูกสร้าง ซึ่งตั้งอยู่<br>
                เป็นอาคารพาณิชย์มีขนาดเนื้อที่ใช้สอยรวมไม่ต่ำกว่า <span class="underline-field">{{ $purchaseOrder->area_size ?? '' }}</span> ตารางเมตร ให้{{ $company['name'] ?? 'บริษัท อินโนบิค นูทริชั่น จำกัด' }} ได้ตาม<br>
                ขอบการดำเนินงานที่กำหนด (รายละเอียดตามเอกสารแนบ)
            </div>
        </div>
        ...
        <div class="section">
            ...
            <div class="subsection">
                ...
                ผู้รับจ้าง/ผู้ขาย/{{ $participantLabel ?? 'ผู้ให้เช่า' }}จะต้องแนบเอกสารประกอบการส่งมอบอื่นๆ อาทิ COA, สบ.5 ., Artwork, Spec, 
                Report,คู่มือการใช้งาน หรือหลักฐานในการส่งมอบ ฯลฯ พร้อมหนังสือส่งมอบงานทุกครั้งหลังจาก 
                ส่งมอบงานแล้วเสร็จ ทั้งนี้เอกสารดังกล่าวเป็นส่วนหนึ่งของการส่งมอบงานหากผู้รับจ้าง/ผู้ขาย/{{ $participantLabel ?? 'ผู้ให้เช่า' }} 
            ...
            <div class="subsection">
                ...
                ในการส่งมอบงานทุกงวดงาน{{ $participantLabel ?? 'ผู้ให้เช่า' }}จะต้องส่งมอบงานผ่านผู้รับมอบงานตามรายละเอียดงาน
                ข้างต้น เท่านั้น
            </div>
        </div>
        ...
        <div class="section">
            ...
            <div class="content-block" style="margin-left: 25px;">
                โดยบริษัทฯ จะจ่ายเงินให้ผู้รับจ้าง/ผู้ขาย/{{ $participantLabel ?? 'ผู้ให้เช่า' }} เมื่อครบ 7-10วัน นับถัดจากวันที่ผู้รับจ้างยื่นหลักฐาน
                การขอรับชำระหนี้ถ้าผู้รับจ้างยื่นหลักฐานการขอรับชำระหนี้เกินกว่าที่กำหนดเป็นระยะเวลาเท่าใด กำหนด
                วันจ่ายเงินจะยืดออกไปเท่ากับวันที่{{ $participantLabel ?? 'ผู้ให้เช่า' }}ยื่นหลักฐานการขอรับชำระหนี้เกินกำหนดเช่นกัน
            </div>
            ...
            <div class="content-block" style="margin-left: 25px;">
                โดยบริษัทฯ จะจ่ายเงินให้แก่ผู้รับจ้าง/ผู้ขาย/{{ $participantLabel ?? 'ผู้ให้เช่า' }} ตามการส่งมอบงานจริงภายใน 30 วัน นับจาก 
        ...
        <div class="section">
            ...
            <div class="checkbox-item">
                ...
                <div>กรณีเช่า ให้ใช้อัตราค่าปรับร้อยละ{{ $penaltyRate ?? '0.2' }} ของมูลค่าการเช่ารวมทั้งสัญญาหรือมูลค่าสินค้าที่จะเช่าหรือมูลค่าการเช่าในแต่ละงวด</div>
            </div>
