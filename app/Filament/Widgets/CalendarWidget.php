...
class CalendarWidget extends FullCalendarWidget
{
    ...
    public function fetchEvents(array $fetchInfo): array
    {
        ...
        // Goods Receipts - filter by company
        $goodsReceipts = GoodsReceipt::whereBetween('receipt_date', [$start, $end])
            ->where('company_id', $companyId)
        ...
        foreach ($goodsReceipts as $gr) {
            ...
            $events->push([
                ...
                'extendedProps' => [
                    'entity_id' => $gr->id,
                    'entity_type' => 'gr',
                    'description' => 'ผู้ขาย: ' . optional($gr->vendor)->name . ' | PO: ' . optional($gr->purchaseOrder)->po_number . ' | สถานะ: ' . $gr->inspection_status_label,
                    'priority' => $priority,
                ],
            ]);
        }
