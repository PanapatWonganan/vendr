...
class RejectPurchaseRequisitionAction extends Action
{
    ...
    protected function setUp(): void
    {
        ...
        $this
            ...
            ->modalDescription('คุณแน่ใจหรือไม่ที่ต้องการปฏิเสธใบขอซื้อนี้?')
            ...
            ->action(function (Model $record, array $data): void {
                ...
                event(new PurchaseRequisitionRejected($record, $user));
